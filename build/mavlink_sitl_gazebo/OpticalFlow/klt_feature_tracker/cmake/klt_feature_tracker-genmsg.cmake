...
get_filename_component(_filename "/home/pcampolucci/autonomy/src/state_estimation/sitl_gazebo/external/OpticalFlow/external/klt_feature_tracker/srv/TrackFeatures.srv" NAME_WE)
add_custom_target(_klt_feature_tracker_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "klt_feature_tracker" "/home/pcampolucci/autonomy/src/state_estimation/sitl_gazebo/external/OpticalFlow/external/klt_feature_tracker/srv/TrackFeatures.srv" "sensor_msgs/Image:std_msgs/Header"
)
...
_generate_srv_cpp(klt_feature_tracker
  "/home/pcampolucci/autonomy/src/state_estimation/sitl_gazebo/external/OpticalFlow/external/klt_feature_tracker/srv/TrackFeatures.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/klt_feature_tracker)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/klt_feature_tracker\")")
  # install generated code
  install(
